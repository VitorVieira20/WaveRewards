...
{
    private array $informationsMock;

    public function __construct()
    {
        $this->informationsMock = [
            [
                'id' => 1,
    ...
    {
        return $this->informationsMock;
    }


    public function getInformationById(int $id)
    {
        $information = array_filter($this->informationsMock, function ($item) use ($id) {
            return $item['id'] === $id;
        });

        return !empty($information) ? array_values($information)[0] : null;
    }
}