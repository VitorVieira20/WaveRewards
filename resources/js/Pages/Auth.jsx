...
export default function Auth({ method }) {
    ...
    return (
        <div className="min-h-screen flex flex-col justify-between bg-gradient-to-b from-[#BED3DC] via-[#60B4D9] via-[#1D87BC] to-[#1C5E8F] text-white">
            ...
            <Link href={route('home.index')} className="flex items-center cursor-pointer pl-14 pt-4">
            ...
            <div className="flex items-center justify-center flex-1 px-4">
                <div className="relative max-w-4xl w-full h-[450px] bg-white/40 backdrop-blur-md rounded-2xl shadow-lg overflow-hidden flex">
            ...
            <div className="flex flex-col items-center justify-center py-6">
                <div className="text-center text-[#60B4D9] text-md font-normal leading-none">
