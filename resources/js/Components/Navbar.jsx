...
const navLinks = [
    { dropdown: false, name: 'Início', href: '/about1' },
    { dropdown: false, name: 'Sobre Nós', href: '/about2' },
    { dropdown: false, name: 'Benefícios', href: '/about3' },
    { dropdown: false, name: 'Rankings', href: '/about4' },
    { dropdown: false, name: 'Contactos', href: '/about5' },
    /* {
        dropdown: true,
        name: 'Modalidades',
        items: [
                    ...
                    <div className="hidden xl:flex items-center gap-1">
                        {auth.user ? (
                            <button onClick={handleLogout} disabled={processing}
                                className="flex bg-blue-500 hover:bg-blue-600 text-white px-6 py-3 transition-all duration-300 transform hover:scale-105 uppercase tracking-wide text-sm rounded cursor-pointer">
