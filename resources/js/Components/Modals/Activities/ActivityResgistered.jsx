...
export default function ActivityRegistered({ isOpen, onClose, points }) {
            ...
            >
                ...
                >
                    <h2 className="w-full text-[#1A3463] text-xl md:text-2xl font-semibold mb-3 drop-shadow-sm">
                        Uau!! Mais uma atividade cumprida.
                    </h2>

                    <p className="text-[#1A3463] text-lg font-normal mb-3">
                        Parabéns, estás num bom caminho!!
                    </p>

                    <p className="text-[#1A3463] text-lg font-normal mb-8">
                        Recebeste <span className="font-semibold text-[#1A3463]/80">{points}</span> pontos!
                    </p>
